...
public class CaveRoom {
	...
	public CaveRoom(String description) {
		...
		//difference between defualtContents and contents is " contents" becomes an 'X' when you are
		// inside this room, when you leave, it goes back to defaultContents
		
		//note:by default, arrays will populate with 'null' meaning here are no connections
	...
	public static void setUpCaves() {
		...
		for(int row = 0; row<CaveExplorer.caves.length;row++) {
			//PLEASE PLAY ATTENTION TO THE DIFFERENCE
